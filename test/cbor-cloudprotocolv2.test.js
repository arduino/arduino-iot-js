...
describe('Test CBOR encoding using CloudProtocol v2', () => {
  ...
  it('[CloudProtocol v2] Generate a valid cbor for multiple properties with basename', () => {
    ...
    const senMlUInt = CBOR.getSenML('test_uint', 4, timestamp, true, deviceId);
    const senMlSInt = CBOR.getSenML('test_sint', -4, timestamp, true, deviceId);
    const senMlFloat = CBOR.getSenML('test_float', 4.5, timestamp, true, deviceId);
    const senMlString = CBOR.getSenML('test_string', 'test value', timestamp, true, deviceId);
  ...
  it('[CloudProtocol v2] Generate a valid cbor for multiple properties with basename', () => {
    ...
    const senMlUInt = CBOR.getSenML('test_uint', 4, timestamp, true);
    const senMlSInt = CBOR.getSenML('test_sint', -4, timestamp, true);
    const senMlFloat = CBOR.getSenML('test_float', 4.5, timestamp, true);
    const senMlString = CBOR.getSenML('test_string', 'test value', timestamp, true);
