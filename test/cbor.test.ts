...
describe('Test CBOR encoding using CloudProtocol v1', () => {
  it('Generate a valid cbor for a senml string property with basename', () => {
    ...
    const cborbase64 = SenML.toString([senMl as any], false);
  ...
  it('Generate a valid cbor for a senml complex property with basename', () => {
    ...
    const senMl = SenML.parse('test_bool', { lat: 60.07967, lon: 24.30628 } as any, timestamp, false, deviceId);
    const cborbase64 = SenML.toString([senMl] as any, false);
    expect(base64toHEX(cborbase64)).toStrictEqual(output);
  });
  ...
  it('Generate a valid cbor for a senml complex property without basename', () => {
    ...
    const senMl = SenML.parse('test_bool', { lat: 60.07967, lon: 24.30628 } as any, timestamp, false, null);
    const cborbase64 = SenML.toString([senMl] as any, false);
    expect(base64toHEX(cborbase64)).toStrictEqual(output);
  });
